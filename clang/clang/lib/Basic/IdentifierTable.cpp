...
#define CASE(LEN, FIRST, THIRD, NAME) \
  ...
  tok::PPKeywordKind id = llvm::StringSwitch<tok::PPKeywordKind>(Name)
      .Case("若", tok::pp_if)
      .Case("另若", tok::pp_elif)
      .Case("否则", tok::pp_else)
      .Case("若尾", tok::pp_endif)
      .Case("若定义", tok::pp_ifdef)
      .Case("消定义", tok::pp_undef)
      .Case("断言", tok::pp_assert)
      .Case("定义", tok::pp_define)
      .Case("若未定义", tok::pp_ifndef)
      .Case("导入", tok::pp_import)
      .Case("杂注", tok::pp_pragma)
      .Case("已定义", tok::pp_defined)
      .Case("包含", tok::pp_include)
      .Case("告警", tok::pp_warning)
      .Case("消断言", tok::pp_unassert)
      .Case("包含下个", tok::pp_include_next)
      .Default(tok::pp_not_keyword);
if (id != tok::pp_not_keyword){
  return id;
}
